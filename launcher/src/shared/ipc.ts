...
export const IPC = {
  ...
  /** Local server host (Paper-family). */
  HOST_LIST: 'host:list',
  HOST_GET: 'host:get',
  HOST_CREATE: 'host:create',
  HOST_UPDATE: 'host:update',
  HOST_DELETE: 'host:delete',
  HOST_ACCEPT_EULA: 'host:accept-eula',
  HOST_GET_PROPERTIES: 'host:get-properties',
  HOST_UPDATE_PROPERTIES: 'host:update-properties',
  HOST_START: 'host:start',
  HOST_STOP: 'host:stop',
  HOST_RESTART: 'host:restart',
  HOST_SEND_COMMAND: 'host:send-command',
  HOST_OPEN_FOLDER: 'host:open-folder',
  HOST_LIST_WORLDS: 'host:list-worlds',
  HOST_SOFTWARE_VERSIONS: 'host:software-versions',
  HOST_SOFTWARE_BUILDS: 'host:software-builds',
  HOST_PLUGINS_LIST: 'host:plugins-list',
  HOST_PLUGINS_SEARCH: 'host:plugins-search',
  HOST_PLUGINS_INSTALL: 'host:plugins-install',
  HOST_PLUGINS_SET_ENABLED: 'host:plugins-set-enabled',
  HOST_PLUGINS_REMOVE: 'host:plugins-remove',
  /** Main → renderer */
  HOST_CONSOLE: 'host:console',
  HOST_STATUS: 'host:status',
  HOST_DOWNLOAD_PROGRESS: 'host:download-progress',
