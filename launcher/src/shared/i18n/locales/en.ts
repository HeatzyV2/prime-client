export const en = {
  ...
  modals: {
    ...
    instance: {
      ...
      subtitle: 'Name it, pick a Minecraft version, then choose Prime (recommended), Fabric, or Vanilla.',
      kind: 'Type',
      kindPrimeHint: 'Recommended — Fabric + Prime Client',
      kindFabricHint: 'Fabric loader only',
      kindVanillaHint: 'Plain Minecraft',
      recommended: 'Recommended',
      primeJarHint: 'Installs {prefix}-*.jar',
      javaHint: 'Java {major}+ recommended',
      primeAutoNote: 'Prime installs Fabric API and the matching Prime Client mod for this version.',
      fabricNote: 'Release versions with Fabric support from Fabric Meta.',
      versionSearch: 'Search versions…',
      versionsLoading: 'Loading versions…',
      primeUnsupported: 'Prime Client is not available for Minecraft {version}.',
      fabricUnsupported: 'Fabric is not available for Minecraft {version}.',
      showAdvanced: 'Advanced (RAM, Java)',
  ...
  instances: {
    ...
    import: 'Import',
    createPrime: 'Create Prime Client',
