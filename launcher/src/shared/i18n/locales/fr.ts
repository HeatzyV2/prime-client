...
export const fr: LocaleCatalog = {
  ...
  modals: {
    ...
    instance: {
      ...
      subtitle: 'Donnez un nom, choisissez une version Minecraft, puis Prime (recommandé), Fabric ou Vanilla.',
      kind: 'Type',
      kindPrimeHint: 'Recommandé — Fabric + Prime Client',
      kindFabricHint: 'Loader Fabric uniquement',
      kindVanillaHint: 'Minecraft vanilla',
      recommended: 'Recommandé',
      primeJarHint: 'Installe {prefix}-*.jar',
      javaHint: 'Java {major}+ recommandé',
      primeAutoNote: 'Prime installe Fabric API et le mod Prime Client correspondant à cette version.',
      fabricNote: 'Versions release avec support Fabric (Fabric Meta).',
      versionSearch: 'Rechercher une version…',
      versionsLoading: 'Chargement des versions…',
      primeUnsupported: 'Prime Client n\'est pas disponible pour Minecraft {version}.',
      fabricUnsupported: 'Fabric n\'est pas disponible pour Minecraft {version}.',
      showAdvanced: 'Avancé (RAM, Java)',
  ...
  instances: {
    ...
    import: 'Importer',
    createPrime: 'Créer Prime Client',
