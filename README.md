...
Le launcher officiel Tauri vit dans [`launcher/`](launcher/). Releases : [GitHub](https://github.com/HeatzyV2/prime-client) · [Site web](https://heatzyv2.github.io/prime-client/) · [docs/GITHUB.md](docs/GITHUB.md)
