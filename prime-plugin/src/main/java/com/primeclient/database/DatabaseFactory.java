package com.primeclient.database;
...
public final class DatabaseFactory {
    ...
    public static Database create(PrimeClientPlugin plugin) {
        FileConfiguration cfg = plugin.getConfig();
        String type = cfg.getString("database.type", "sqlite");
        HikariConfig hikari = new HikariConfig();
        hikari.setPoolName("PrimeClient");
        ...
        if ("mysql".equalsIgnoreCase(type)) {
            ...
            String db = cfg.getString("database.mysql.database", "primeclient");
            ...
            File file = new File(plugin.getDataFolder(), cfg.getString("database.sqlite-file", "primeclient.db"));
