package com.primeclient.placeholders;
...
public final class PrimePlaceholders extends PlaceholderExpansion {
    ...
    public PrimePlaceholders(PrimeClientPlugin plugin, ClientDetectionService detection, Database database) {
        this.plugin = plugin;
    ...
    public @Nullable String onPlaceholderRequest(Player player, @NotNull String params) {
        ...
        return switch (params.toLowerCase()) {
            case "status" -> detection.isVerified(player.getUniqueId()) || player.hasPermission("primeclient.verified")
