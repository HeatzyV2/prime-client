...
import dev.primeclient.v1_21_10.render.PanelBlur;
...
/**
 * ClickGUI screen for 1.21.10. Thin shell around the core {@link ClickGui}.
 */
public final class ClickGuiScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
        if (minecraft.level != null) {
            // In-world: dim overlay only — MC 1.21.10 allows one blur call per frame.
