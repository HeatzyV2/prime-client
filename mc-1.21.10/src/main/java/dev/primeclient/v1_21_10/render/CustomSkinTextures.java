...
public final class CustomSkinTextures {
    ...
    private record Entry(ResourceLocation id, String hash, DynamicTexture texture) {
    }
    ...
    public static PlayerSkin maybeOverride(UUID uuid, boolean localPlayer, PlayerSkin original) {
        ...
        ResourceLocation bodyId = ensureRegistered(uuid, hash, png);
        if (bodyId == null) {
            return original;
        }
    ...
    private static ResourceLocation ensureRegistered(UUID uuid, String hash, byte[] png) {
