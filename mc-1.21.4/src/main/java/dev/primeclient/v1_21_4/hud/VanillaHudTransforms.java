package dev.primeclient.v1_21_4.hud;
...
public final class VanillaHudTransforms {
    ...
    public static void push(GuiGraphics graphics, VanillaHudComponent component) {
        ...
        pose.pushPose();
        pose.translate(targetX + width / 2f, targetY + height / 2f, 0f);
        if (rotation != 0f) {
        ...
        pose.translate(-(defaultX + localWidth / 2f), -(defaultY + localHeight / 2f), 0f);
