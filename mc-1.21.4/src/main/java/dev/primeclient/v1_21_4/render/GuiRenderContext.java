...
/** {@link RenderContext} over 1.21.4's immediate-mode {@link GuiGraphics}. */
public final class GuiRenderContext implements RenderContext {
    ...
    public void drawTexture(String texturePath, int x, int y, int width, int height,
        ...
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(PrimeClient.MOD_ID, normalizeTexturePath(texturePath));
        // 1.21.6+ treats blit tint as ARGB — always pass an explicit opaque color (no-color overload breaks alpha).
        graphics.blit(RenderType::guiTextured, id, x, y, 0f, 0f, width, height,
    ...
    /** Fabric/MC GUI textures use {@code textures/...} paths in {@link ResourceLocation}s. */
