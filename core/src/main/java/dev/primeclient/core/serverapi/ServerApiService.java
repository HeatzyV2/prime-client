package dev.primeclient.core.serverapi;

import com.google.gson.JsonObject;
import dev.primeclient.core.PrimeClient;
import dev.primeclient.core.adapter.MinecraftAdapter;
import dev.primeclient.core.design.PrimeVersion;
...
/**
 * Client-side bus for the {@code primeclient:main} custom payload channel.
 */
public final class ServerApiService {
    ...
    public void onPayload(String json) {
        ...
        switch (type) {
            case ServerApiProtocol.T_SERVER_ACCEPTED -> {
                ...
                String msg = ServerApiProtocol.str(obj, "message", "Server accepted Prime Client");
    ...
    /** Convenience for hooks before {@link PrimeClient} is fully wired in tests. */
    public static boolean tryHandleClientCommand(String message) {
        try {
            return PrimeClient.get().serverApi().handleClientCommand(message);
